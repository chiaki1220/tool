...
mkdir -p /root/speedtest-cli && curl -sLo /root/speedtest-cli/speedtest https://github.com/chiaki1220/tool/raw/main/speedtest && chmod +x /root/speedtest-cli/speedtest
